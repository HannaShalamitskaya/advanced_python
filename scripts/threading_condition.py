...
if __name__ == "__main__":
    condition = Condition()
    condition_thread_odd = Thread(target=printer,
                                  args=(condition, is_number_odd, "odd "))
    condition_thread_even = Thread(target=printer,
                                   args=(condition, is_number_even, "even"))
